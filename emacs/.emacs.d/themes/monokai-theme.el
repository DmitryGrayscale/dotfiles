...
(defcustom monokai-bg "#262626"
  "Adaptive colors - background"
  :type 'string
  :group 'monokai)

(defcustom monokai-bg-ansi "#454545"
  "Adaptive colors - background ansi"
  :type 'string
  :group 'monokai)
...
;;   highlight-indentation
   ...
   `(highlight-indentation-face
     ((,class (:background ,monokai-bg :foreground "#6c6c6c"))
      (,terminal-class (:background ,terminal-monokai-gray))))
  ...
  (custom-theme-set-variables
   'monokai
   `(ansi-color-names-vector [,monokai-bg-ansi ,monokai-red ,monokai-green ,monokai-yellow
